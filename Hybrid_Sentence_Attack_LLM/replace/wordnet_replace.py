...
def wordnet_replace(
    ...
    """Try WordNet synonyms at a position; return first success or best drop.

    Returns (success, new_query, new_prob, query_count)
    """
    ...
    for cur_syn in syns:
        ...
        # Compute predicted class index for label flip detection
        pred_idx = 0
